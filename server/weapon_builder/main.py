...
def fill_and_save(index, template, csv_weapon, w_extractor, ammo_extractor, proj_extractor, spell_extractor,
    ...
    w_extractor.set_apply(template, csv_weapon, MissedWeaponChecker.not_apply)
    ...
    w_extractor.set_spell(template, csv_weapon, spell_extractor, perk_extractor)
    w_extractor.set_damage_data(template, csv_weapon)
    ...
    w_extractor.set_base_damage_type(template, csv_weapon)
    w_extractor.set_crit(template, csv_weapon, spell_extractor, perk_extractor)
    w_extractor.set_damage(template, csv_weapon)
