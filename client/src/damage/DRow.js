    ...
    return (
        <Col>
            <InputGroup className="mb-1 mt-1 flex-nowrap">
                ...
                <InputGroup.Text style={{ width: '9rem' }} className={color}>{name}</InputGroup.Text>
...
function DRow({damage, setDamage, damage_type, color}) {
    return (
        <Row>
            {column(damage, setDamage, damage_type, "damage", "used_damage", "use_damage", color, damage_type["symbol"] + " Damage")}
            {column(damage, setDamage, damage_type, "mod_damage", "used_mod_damage", "use_mod_damage", color, damage_type["symbol"] + " Mod Damage")}
            {column(damage, setDamage, damage_type, "time_damage", "used_time_damage", "use_time_damage", color, damage_type["symbol"] + " Time Damage")}
        </Row>
    );
}
