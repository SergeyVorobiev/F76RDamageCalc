...
const BoostStuff = memo(function BoostStuff({foodPref, setFoodPref, magazines, setMagazines, bobbleHeads, setBobbleHeads, food, setFood, drink, setDrink, psycho, setPsycho, serum, setSerum, others, setOthers, player, setPlayer, stuffBoost, setStuffBoost, showStat, setShowStat, boostDamage, setBoostDamage, playerStats, setPlayerStats}) {
    return (
        <Accordion className="accordion">
            ...
            <EffectView eventKey="6" foodPref={foodPref} setFoodPref={setFoodPref} player={player} showStat={showStat} setShowStat={setShowStat} categoryName={"Serums"} items={serum} setItems={setSerum} colorName={"green"} colorValue={"green"} cardHeight={'13.7rem'} picHeight={'8rem'} imPadding='1rem 2.5rem' getPicture={getSerum} useHeader={true} stuffBoost={stuffBoost} setStuffBoost={setStuffBoost} />
