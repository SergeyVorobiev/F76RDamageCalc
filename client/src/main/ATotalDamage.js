            ...
            <Card style={{ minWidth: mWidth}} className="d-flex justify-content-center text-center mb-0">
                ...
                <Card.Body className="pt-2 bg-lite">
                    <Row>
                        ...
                        <div className="col d-flex justify-content-center mb-2">
                            <EnemiesInfoView className="main-display-adjustable" sbq={this.props.creatures.sbq} earle={this.props.creatures.earle} titan={this.props.creatures.titan} creature={this.props.creatures.creature} setCreatures={this.props.setCreatures} resultDamage={this.props.resultDamage} weaponName={this.props.weaponName} mapCreatures={this.props.mapCreatures} />
                        </div>
                    </Row>
                </Card.Body>
