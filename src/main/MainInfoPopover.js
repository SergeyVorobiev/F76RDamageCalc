...
export const mainInfoPopover = (
    <Popover className="popover-adjustable">
        ...
        <Popover.Body className="popover-body3">
            ...
            <p className="m-1"><strong>DPS</strong> (damage per second) is also counting reload time. If you have only 1 slot in a magazine, 1 shot per second, 10 damage per shot and 1 second to reload, then dps = 5 provided that resistances of creature = 0.
            Charts show <b>DPS</b> provided that <b>Sneak</b> triggers every hit and <b>Crit</b> / <b>HeadShot</b>
            trigger as specified, accuracy and chance counting for every damage separately.
            Time damage is counting without stacking. Charge time is counting. Attack delay is counting. Consecutive hits, First Blood, Last Shot, Executioner <b>are not counting, but they are counting when life time of creature is calculated</b>.</p>
