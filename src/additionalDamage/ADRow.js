        ...
        <Row>
            <Card className="mb-2 pt-2 pb-2 ps-3 pe-3">
                <Col>
                    ...
                    <Slider onChange={slideChanged} onChangeComplete={onAfterChange} tooltip={{ open: false }} marks={marks.marks} min={marks.min} max={marks.max} step={marks.step} value={additionalDamage.value} />
                </Col>
            </Card>
        </Row>
    );
